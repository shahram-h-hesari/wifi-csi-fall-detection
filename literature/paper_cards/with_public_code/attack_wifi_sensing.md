# Paper Card: attack_wifi_sensing

**Paper ID:** `attack_wifi_sensing`
**Card Type:** with_public_code
...
| Dataset available | Synthetic CSI (pending verification) |
...
| Chapter 6: Software-Based Hardening | Supporting reference |
